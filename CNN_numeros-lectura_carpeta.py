...
# Para la librería anterior hay que comentar la importación que hace el error, además
## de la función que usa, no afecta al código, esta parte está en desuso desde hace tiempo
import math
import numpy as np
...
#### Creación de la imagen del summary
...
#### Creación de la imagen de la matriz de confusión
...
#Guardamos el modelo de las letras para su posterior uso en conjunto con algun otro modelo
model.save('modelo_numeros001.h5')

###############################################################################

#### Creación de la imagen para ver una clasificación
...
folder_path = 'C:\\Users\\PC\\Desktop\\Proyecto_lectura_LNS\\numeros_computadora'
...
plt.tight_layout()
plt.savefig('Prueba_numeros_001.jpg')
plt.show()
